...
contract HozziCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function HozziCoin() {
        ...
        name = "HozziCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "HOZZI";                                             // Set the symbol for display purposes (CHANGE THIS)
